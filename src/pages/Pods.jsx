...
export default function Pods() {
  return(
    <div>
      <h1> 347 Podcast </h1>
        <p> The 347podcast is a short form conversation with friends and guests that range from entertainers, organizers, and beyond. 
          We like meeting no people, so no conversation is safe, and all guests are welcome. Come vibe with us.
        </p>
